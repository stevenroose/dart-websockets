...
import "src/connect_interface.dart"
    if (dart.library.io) "src/io_websocket_impl.dart"
    if (dart.library.html) "src/html_websocket_impl.dart" as connector;
...
abstract class WebSocket implements StreamSink, Stream {
  ...
  static Future<WebSocket> connect(url,
      ...
      connector.connect(url, protocols: protocols, headers: headers);
